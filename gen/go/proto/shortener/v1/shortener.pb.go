...
const file_proto_shortener_v1_shortener_proto_rawDesc = "" +
	"\n" +
	"\"proto/shortener/v1/shortener.proto\x12\fshortener.v1\x1a\x1cgoogle/api/annotations.proto\"3\n" +
	...
	"\foriginal_url\x18\x01 \x01(\tR\voriginalUrl2\xdc\x01\n" +
	"\x10ShortenerService\x12^\n" +
	"\aShorten\x12\x1c.shortener.v1.ShortenRequest\x1a\x1d.shortener.v1.ShortenResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/v1/shorten\x12h\n" +
	"\aResolve\x12\x1c.shortener.v1.ResolveRequest\x1a\x1d.shortener.v1.ResolveResponse\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/v1/resolve/{short_code}BJZHgithub.com/palashb01/url-shortener/gen/go/proto/shortener/v1;shortenerv1b\x06proto3"

var (
	file_proto_shortener_v1_shortener_proto_rawDescOnce sync.Once
	file_proto_shortener_v1_shortener_proto_rawDescData []byte
)

func file_proto_shortener_v1_shortener_proto_rawDescGZIP() []byte {
	file_proto_shortener_v1_shortener_proto_rawDescOnce.Do(func() {
		file_proto_shortener_v1_shortener_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_shortener_v1_shortener_proto_rawDesc), len(file_proto_shortener_v1_shortener_proto_rawDesc)))
	})
	return file_proto_shortener_v1_shortener_proto_rawDescData
}

var file_proto_shortener_v1_shortener_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
func file_proto_shortener_v1_shortener_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_shortener_v1_shortener_proto_rawDesc), len(file_proto_shortener_v1_shortener_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
